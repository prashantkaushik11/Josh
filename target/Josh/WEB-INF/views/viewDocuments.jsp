        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach items="${documentList}" var="document">
                <tr>
                    ...
                    <td> <a href="<c:url value="/student/document/download/${document.documentId}"/>"><button class="btn btn-info btn-lg">Download</button></a> <td>
                   <!-- <td> <a href="<c:url value="/student/document/delete/${document.documentId}"/>"><button class="btn btn-danger btn-lg">Delete</button></a> <td>-->
                </tr>
            </c:forEach>
        </table>
